...
namespace Capa_Vista_Cuentas_Corrientes
{
    public partial class NuevosProveedores : Form
    {
        ...
        {
            //controlador.guardarProveedor(Txt_id_proveedor.Text, dtp_fecha_registro.Text, Txt_nombre.Text, Txt_direccion.Text, Txt_telefono.Text, Txt_email.Text, Txt_saldo.Text, Cbo_estado.Text);
            //actualizarVistaProveedor();
            //getIdP();
        }
